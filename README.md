...
![MatchYawDemo](https://cdn.discordapp.com/attachments/832779512738873444/1001989792755621988/new_input_direction_gif.gif)
...
- Record Ghost
  - starts/stops recording a ghost for use with [Frame's STROOP refactor](https://github.com/chaosBrick/STROOP) (`tmp.ghost` file is saved in `InputDirection_dev folder by
    default
- Atanstrain
