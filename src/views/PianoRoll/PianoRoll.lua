...
---@field public startGT integer The global timer value indicating the start of this piano roll.
...
---@field public endGT integer The global timer value indicating the end of this piano roll.
