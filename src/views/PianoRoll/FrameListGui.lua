...
local function UpdateScroll()
    local maxScroll = PianoRollContext.current:numFrames() - PianoRollContext.maxDisplayedFrames - 1
...
local function DrawColorCodes()
    ...
    local height = rect.height * (NumDisplayFrames() + 1)
...
local function DrawFramesGui(draw, buttonDrawData)
    ...
    for i = 0, PianoRollContext.current:numFrames(), 1 do
        ...
        local input = PianoRollContext.GetInput(globalTimer)
